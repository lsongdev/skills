...
parser.add_argument('--sleep',      default='./sleep_raw.json')
parser.add_argument('--spo2',       default='./spo2_raw.json')
parser.add_argument('--out-prefix', default='./sleep_month_trend')
