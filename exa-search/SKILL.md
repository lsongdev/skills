...
python3 ~/.agents/skills/exa-search/scripts/query.py list_tools

# General search
python3 ~/.agents/skills/exa-search/scripts/query.py call_tool web_search_exa '{"query":"latest changes in Exa MCP docs","numResults":5}'

# Fetch page content
python3 ~/.agents/skills/exa-search/scripts/query.py call_tool web_fetch_exa '{"urls":["https://exa.ai/docs/reference/exa-mcp"]}'

# Advanced search with filters
python3 ~/.agents/skills/exa-search/scripts/query.py call_tool web_search_advanced_exa '{"query":"Exa MCP documentation","includeDomains":["exa.ai"],"numResults":5,"enableHighlights":true}'
```
...
- If missing when needed, prompt the user to set the environment variable `EXA_API_KEY`.
